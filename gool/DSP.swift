...
class DSP {
    ...
    static let RDP_SANDY_DRY = 2.550,
               ...
               RDP_CLAY_DRY = 2.380
    //clayey soil's RDP varies more with frequency than other soil types
    ...
    static func spline(var yNew: [Double], xNew: [Double], var x: [Double], var y: [Double]) {
        let n = x.count
